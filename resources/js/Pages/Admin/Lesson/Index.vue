        ...
        <div class="bg-white shadow-sm sm:rounded-lg p-6 border border-gray-200">
            ...
            <div class="mb-6 flex w-full items-center justify-between border-b border-gray-200 pb-4">
                <div class="flex gap-4">
                    ...
                    <button type="button" @click="isSearchOpen = !isSearchOpen"
            ...
            <div v-if="isSearchOpen" class="mb-6 w-full">
                <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/50">
                    <form @submit.prevent="handleSearch" class="grid items-end gap-4 lg:grid-cols-[1fr_auto]">
            ...
            <div class="overflow-x-auto bg-white rounded-lg border border-gray-200">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        <tr v-for="(lesson, index) in lessonList" :key="lesson.id ?? index"
                            ...
                            <td class="px-4 py-3 text-sm text-gray-600">{{ lesson.creator.first_name }} {{
                                lesson.creator.last_name }}</td>
                            <td class="px-4 py-3 text-center text-sm">
                                <div class="flex items-center justify-center gap-3">
                                    ...
                                    <button type="button" @click="deleteLesson(lesson.id)"
                        ...
                        <tr v-if="!lessonList.length">
                            <td colspan="6" class="text-center py-10 text-gray-500 text-sm font-medium">No records
                                found.</td>
                        </tr>
                    </tbody>
                </table>
