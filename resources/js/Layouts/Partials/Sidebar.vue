            ...
            <nav v-if="currentUser.role === 'Admin' || currentUser.role === 'Teacher'" class="py-4 px-3 space-y-2">
                ...
                <Link href="/users"
                    ...
                    <svg :class="[isCurrentRoute('/users') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-400 group-hover:text-gray-500']"
                        class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <nav v-if="currentUser.role === 'Learner'" class="py-4 px-3 space-y-2">
                ...
                <Link href="/dashboard"
                    ...
                    <svg :class="[isCurrentRoute('/dashboard') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-400 group-hover:text-gray-500']"
                        class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
